...
const Footer = () => {
  return (
    <footer className="bg-gray-900 dark:bg-black text-gray-300 pt-12 pb-6 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div className="flex gap-4 mt-4">
            ...
            <a href="#" className="text-gray-400 hover:text-green-400 transition text-xl"><FaXTwitter /></a>
