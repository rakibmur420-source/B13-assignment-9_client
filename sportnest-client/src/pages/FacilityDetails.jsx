  ...
  if (!facility) {
    return (
      <div className="flex justify-center items-center min-h-screen bg-white dark:bg-gray-900">
        <p className="text-gray-500 dark:text-gray-400 text-xl">Facility not found!</p>
      </div>
    );
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6 mt-6">
              <span className="text-xs bg-green-100 dark:bg-green-900 text-green-600 dark:text-green-300 px-3 py-1 rounded-full font-medium">
              ...
              <div className="grid grid-cols-2 gap-4 mt-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
                  <p className="text-gray-500 dark:text-gray-400 text-xs">Price Per Hour</p>
                  <p className="font-semibold text-green-500">
                    ৳{facility.price_per_hour}
                  </p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
                  <p className="text-gray-500 dark:text-gray-400 text-xs">Slots</p>
                  <p className="font-semibold text-gray-800 dark:text-white">
                    🕒 {facility.available_slots?.length || 0} available
                  </p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
                  <p className="text-gray-500 dark:text-gray-400 text-xs">Bookings</p>
                  <p className="font-semibold text-gray-800 dark:text-white">
              ...
              <div className="mt-4">
                <p className="text-gray-500 dark:text-gray-400 text-xs mb-1">About this facility</p>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  {facility.description}
                </p>
              </div>
              <div className="mt-4">
                <p className="text-gray-500 dark:text-gray-400 text-xs mb-1">Available Slots</p>
                <div className="flex flex-wrap gap-2">
                  {(facility.available_slots || []).map((slot, i) => (
                    <span
                      key={i}
                      className="bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 text-xs px-3 py-1 rounded-full"
                    >
                      {slot}
                    </span>
                  ))}
          ...
          >
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6 sticky top-24">
              ...
              <div className="space-y-4">
                ...
                {/* Total Price */}
                <div className="bg-green-50 dark:bg-green-950 rounded-lg p-4 flex justify-between items-center">
