            ...
            {facilities.map((facility, index) => (
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <span className="text-xs bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 px-2 py-1 rounded-full w-fit font-medium mt-2">
          ...
          {editFacility && (
            ...
            >
              <motion.div
                ...
                className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 w-full max-w-lg max-h-[90vh] overflow-y-auto"
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="flex-1 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 py-3 rounded-lg font-semibold transition"
                    >
                      Cancel
                    </button>
                  </div>
